...
class SeoSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $jsonLdSchema = [
            ...
            'logo' => 'https://dancell-official.com/assets/images/logo-dancell.png',
            'image' => 'https://dancell-official.com/assets/images/og-dancell.jpg',
        ...
        SeoSetting::updateOrCreate(
            ...
            [
                ...
                'og_image' => 'https://dancell-official.com/assets/images/og-dancell.jpg',
                'og_type' => 'website',
